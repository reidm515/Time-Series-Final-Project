...
def checkFileType(file_name):
    ...
    """
    Checks if the given file has the correct file extension (CSV).
    
    Parameters:
    file_name (str): The name of the CSV file containing the weather dataset.

    Returns:
    Raises a ValueError if the file extension is not .csv, or a FileNotFoundError if the file is not found.
    """
